...
<script>
    ...
    function lista_sesion(ingreso) {
        ...
        obj.open("POST", "sesion_nutricionista_carga.jsp", true);
...
<legend>Ingreso sesión nutricionista</legend>
...
<form  action='../PDF_sesion_nutricionista' id="form_documento_registro" method='POST' target='_blank' >
...
<form name="form_sesion_nutricion" action="#" method="POST" onsubmit="return false"  >
