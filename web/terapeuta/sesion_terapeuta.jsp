...
<script>
    ...
    function lista_sesion(ingreso) {
        ...
        obj.open("POST", "sesion_terapeuta_carga.jsp", true);
...
<legend>Ingreso sesión Terapeuta</legend>
...
<form  action='../PDF_sesion_terapeuta' id="form_documento_registro" method='POST' target='_blank' >
