    ...
    public void onOpenDocument(PdfWriter writer, Document document) {
        try {
          HeaderImage =Image.getInstance("D:/VICTOR/ProyectosWeb/modulo_uo/web/Imagenes/membrete.png");//(path +"logo_gobierno.JPG");
            Logo_crs =Image.getInstance("D:/VICTOR/ProyectosWeb/modulo_finanzas/web/Imagenes/logo_crs.png");//(path +"logo_gobierno.JPG");
            FooterImage2 =Image.getInstance("D:/VICTOR/ProyectosWeb/modulo_finanzas/web/Imagenes/FooterSDGP.png");//(path +"logo_gobierno.JPG");
