<%-- 
    Document   : datos_paciente
    Created on : 17-may-2012, 12:32:38
    Author     : EseGamboa
--%>
...
<body onload="history.forward();displayMessage('../datos/datos_paciente_carga.jsp?duo=<% out.write("" + guarda_duo);%>')">
</body>
</html>
