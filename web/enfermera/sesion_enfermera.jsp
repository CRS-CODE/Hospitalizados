...
<script>
    ...
    function lista_sesion(ingreso) {
        ...
        if (ingreso === 1) {
            var detalle = $("#txa_detalle").val().replaceAll("%", "");
        ...
        obj.open("POST", "sesion_enfermera_carga.jsp", true);
...
<legend>Ingreso sesión Enfermera</legend>
...
<form  action='../PDF_sesion_enfermera' id="form_documento_registro" method='POST' target='_blank' >
...
<form name="form_sesion_enfermera" action="#" method="POST" onsubmit="return false"  >
