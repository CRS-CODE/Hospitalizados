...
<legend>Ingreso sesión de Psicologia</legend>
...
<form  action='../PDF_sesion_psicolo' id="form_documento_registro" method='POST' target='_blank' >
...
<form name="form_sesion_psicologia" action="#" method="POST" onsubmit="return false"  >
