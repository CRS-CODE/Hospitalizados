...
<script>
    ...
    function cerrar() {
        document.location.href = '<%=neg.getLocal()%>/uh_visita.jsp';
    }
</script>
<script>
       ...
       <div id="Resultado" style=" overflow:auto;
            ...
            <table border="0" style="FONT-FAMILY: Arial, Helvetica, sans-serif; FONT-SIZE: 12px;">
                ...
                <tr>
                    <td colspan="4" width="150px">
                        <textarea rows="10" cols="90" name="anamnesis" id="anamnesis" title="Anamnesis" onblur="onBlurAnamnesis();" onfocus="onFocusAnamnesis()" style=" color: gray  "   >Anamnesis...</textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="5">
        ...
        <fieldset id="FielDiagnostico" style="">
            ...
            <table>
                ...
                <tr>
                    <td>
                        <input type="text" size="80" id="diagnostico" style="text-transform:capitalize; color: gray " onblur="onBlurDiag();" onfocus="onFocusDiag();" onkeypress="return valida_enter_txt_diagnostico(event)"  value="Ingrese Diagnostico">
        ...
        <fieldset>
            <legend>Indicaciones médicas:</legend>
            <textarea rows="10" cols="90" name="indicacionesMedicas" id="indicacionesMedicas" title="Indicaciones Médicas" onblur="onBlurAnamnesis();" onfocus="onFocusAnamnesis()" style=" color: gray  "   ></textarea>
        </fieldset>                 
