...
<%
    ...
    out.write("</table>");
        ...
        while (it_visita.hasNext()) {
            ...
            out.write("<td> <a href='http://10.8.4.9:9090/modulo_uo/Visita/CategorizacionPDF.jsp?id_visita=" + vis.getId_visita_categorizacion() + "' target='a_blank'  > " + vis.getFecha_visita() + "</a></td>");
