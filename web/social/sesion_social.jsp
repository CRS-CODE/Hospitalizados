...
<script>
    ...
    function lista_sesion(ingreso) {
        ...
        obj.open("POST", "sesion_social_carga.jsp", true);
...
<legend>Ingreso sesión Trabajadora Social</legend>
...
<form  action='../PDF_sesion_social' id="form_documento_registro" method='POST' target='_blank' >
...
<form name="form_sesion_terapeuta" action="#" method="POST" onsubmit="return false"  >
