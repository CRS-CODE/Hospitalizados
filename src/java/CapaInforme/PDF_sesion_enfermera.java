 ...
 * @author Kairin
 */
public class PDF_sesion_enfermera extends HttpServlet {
     ...
     */
        ...
        ArrayList lista_sesion = neg.lista_sesion_enfermera(id_duo);
        ...
        try {
            ...
            String tipo_informe = "Evaluacion Enfermera";
...
//FIN IMAGEN
            ...
            PDF_sesion_enfermera.FooterPiePaginaiText_sesion footer = new PDF_sesion_enfermera.FooterPiePaginaiText_sesion();
