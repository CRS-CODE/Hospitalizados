 ...
 * @author EseGamboa
 */
public class PDF_ingreso_enfermeriaOLD extends HttpServlet {
...
//      Document document = new Document(PageSize.A4, 50, 50, 50, 50);
        ...
        cIngresoEnfermeria eu = neg.obtiene_ingreso_enfermeriaOld(id_duo);
...
//  tabla1.setWidths(medidaCeldas);
           ...
           // celda.setFixedHeight(100f);
            ...
            Logger.getLogger(PDF_ingreso_enfermeriaOLD.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception e) {
            Logger.getLogger(PDF_ingreso_enfermeriaOLD.class.getName()).log(Level.SEVERE, null, "Ocurrio un Error" + e);
        }
