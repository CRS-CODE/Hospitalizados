 ...
 * @author Informatica
 */
public class PDF_sesion extends HttpServlet {
...
//      Document document = new Document(PageSize.A4, 50, 50, 50, 50);
        ...
        ArrayList lista_sesion = neg.lista_historial_sesion(id_duo);
...
//FIN IMAGEN
            ...
            PDF_sesion.FooterPiePaginaiText_visita_medica footer = new PDF_sesion.FooterPiePaginaiText_visita_medica();
...
//  tabla1.setWidths(medidaCeldas);
            ...
            if (lista_sesion.isEmpty()) {
                ...
                while (it_ses.hasNext()) {
                    ...
                    if (!vis.getDia_visita().equals(guarda_fecha)) {
                        // celda = new PdfPCell(new Paragraph("                                                                 Día " + ses.getFecha(), ft1));

                        celda = new PdfPCell(new Paragraph("Día " + vis.getDia_visita(), ft1));
                    ...
                    celda = new PdfPCell(new Paragraph("" + vis.getHora_visita(), ft4));
                    celda.setColspan(1);
                    tabla3.addCell(celda);
                    celda = new PdfPCell(new Paragraph("" + vis.getObs_visita(), ft4));
                    celda.setColspan(1);
                    tabla3.addCell(celda);

                    celda = new PdfPCell(new Paragraph("" + vis.getNombre_usuario() + "\n" + vis.getApellidop_usuario(), ft5));
                    celda.setColspan(1);
                    tabla3.addCell(celda);

                    guarda_fecha = vis.getDia_visita();
                }
                /**/
            }
            ...
            Logger.getLogger(PDF_sesion.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception e) {
            Logger.getLogger(PDF_sesion.class.getName()).log(Level.SEVERE, null, "Ocurrio un Error" + e);
        }
