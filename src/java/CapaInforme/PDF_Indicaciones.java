 ...
 * @author a
 */
public class PDF_Indicaciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String tipo_informe = "Indicaciones Médicas \n Unidad de Media Estadía CRS Maipú";
...
//FIN IMAGEN
            ...
            PDF_Indicaciones.FooterPiePaginaiText_visita_medica footer = new PDF_Indicaciones.FooterPiePaginaiText_visita_medica();
            ...
            Font ft11 = FontFactory.getFont("Calibri", 11, Font.BOLDITALIC, BaseColor.BLUE);
            ...
            float[] colsWidthtk = {0.4f, 0.4f, 0.4f, 0.4f, 0.4f, 0.4f};
            ...
            celda = new PdfPCell(new Paragraph("Día(s) Hospitalizado(a)", ft3));
            celda.setBackgroundColor(myColor);
            celda.setColspan(1);
            tablak.addCell(celda);
 ...
 /* TABLA 3*/
            ...
            celda = new PdfPCell(new Paragraph("Diagnostico", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
               celda = new PdfPCell(new Paragraph("" + rec.getDiagnostico(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            
            celda = new PdfPCell(new Paragraph("Reposo", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getReposo(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            
            celda = new PdfPCell(new Paragraph("Regimen", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getRegimen(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            
            
            celda = new PdfPCell(new Paragraph("Control de Signos vitales", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getControl_signos(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            
            
             celda = new PdfPCell(new Paragraph("Aislamiento", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getAislamiento(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
             celda = new PdfPCell(new Paragraph("Alergias", ft4));
            
            celda.setColspan(1);
            tabla3.addCell(celda);
            celda = new PdfPCell(new Paragraph("" + rec.getAlergias(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            
            celda = new PdfPCell(new Paragraph("Contencion", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getContencion(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            celda = new PdfPCell(new Paragraph("Imagenes", ft4));
           
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getImagenes(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            
             celda = new PdfPCell(new Paragraph("Otros", ft4));
           
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getOtros(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            ...
            celda = new PdfPCell(new Paragraph("Enfermeria", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getIndicaciones_enfermeria(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            
             celda = new PdfPCell(new Paragraph("Nutricionista", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getIndicaciones_nutricionista(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            
             celda = new PdfPCell(new Paragraph("Kinesiologia", ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);

            celda = new PdfPCell(new Paragraph("" + rec.getIndicaciones_kinesiologo(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            ...
            celda = new PdfPCell(new Paragraph("" + rec.getIndicaciones_otros(), ft4));
            celda.setColspan(1);
            tabla3.addCell(celda);
            ...
            /*solicitud de examnes */
            Vector<String> recetario = neg.buscarSolicitudExamenesdeIndicaciones(idindicacion);
            String mense = "";
            boolean tengosolicitud= false;
            for (int i = 0; i < recetario.size(); i++) {
                mense = mense + neg.upperCaseFirst(recetario.get(i)) + "  \n";
                tengosolicitud= true;
            }
        if (tengosolicitud == true) {
                celda = new PdfPCell(new Paragraph("Solicitud de Examenes", ft3));
                celda.setBackgroundColor(myColor);
                celda.setColspan(2);
                tabla3.addCell(celda);

                celda = new PdfPCell(new Paragraph("" + mense, ft4));
                celda.setColspan(2);
                tabla3.addCell(celda);
            }
