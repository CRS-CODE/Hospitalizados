 ...
 * @author EseGamboa
 */
public class XLS_DuosDadoAltaSimple extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       // String path2 = context.getRealPath("\\imagen\\").replace("build", "");
        ...
        try {
            ...
            cell.setCellValue("INFORME DE PACIENTES YA DADOS DE ALTA (BASADO EN FECHA INGRESO)"); //vacia el nombre de las columnas en la hoja de excell
            ...
            cell.setCellValue("RUT MEDICO INGRESA");
            cell.setCellStyle(style_Destacado);
            cell = row.createCell((short) 18); //crea la celda tipo
            cell.setCellValue("RUT ENFERMERA INGRESA");
            cell.setCellStyle(style_Destacado);
            cell = row.createCell((short) 19); //crea la celda tipo
            cell.setCellValue("FECHA Y HORA DE INGRESO ENFERMERIA");
            cell.setCellStyle(style_Destacado);
            cell = row.createCell((short) 20); //crea la celda tipo
            cell.setCellValue("RUT MEDICO EGRESA");
            cell.setCellStyle(style_Destacado);
            cell = row.createCell((short) 21); //crea la celda tipo
            cell.setCellValue("FECHA Y HORA DE INGRESO MEDICO");
            cell.setCellStyle(style_Destacado);
            ...
            while (it_lista.hasNext()) {
                ...
                cell.setCellStyle(style_Normal);
                cell = row.createCell((short) 17); //crea la celda tipo
                cell.setCellValue(vis.getRut_medico_ingresa());
                cell.setCellStyle(style_Normal);
                cell = row.createCell((short) 18); //crea la celda tipo
                cell.setCellValue(vis.getRut_enfermera_ingresa());
                cell.setCellStyle(style_Normal);
                cell = row.createCell((short) 19); //crea la celda tipo
                cell.setCellValue(vis.getFecha_hora_ingresa_enfermera());
                cell.setCellStyle(style_Normal);
                cell = row.createCell((short) 20); //crea la celda tipo
                cell.setCellValue(vis.getRut_medico_egresa());
                cell.setCellStyle(style_Normal);
                cell = row.createCell((short) 21); //crea la celda tipo
                cell.setCellValue(vis.getFecha_hora_ingreso_medico());
                cell.setCellStyle(style_Normal);
            }
