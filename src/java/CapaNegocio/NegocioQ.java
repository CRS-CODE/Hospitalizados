...
public class NegocioQ extends Negocio {
    ...
    public DuoIndexBarthel getDuoIndexBarthel(int id) {
        ...
        this.cnn.setSentenciaSQL("SELECT\n"
                ...
                + "                FROM\n"
                + "                  schema_uhd.duo_index_barthel dib inner join schema_uhd.duo d on dib.id_duo= d.id_duo\n"
                + "                  inner join agenda.paciente p on p.rut= d.rut_paciente\n"
                + "                  inner join schema_uhd.usuario u on dib.user_registers = u.rut_usuario where dib.id = " + id + ";");
        this.cnn.conectar();
        try {
            if (cnn.getRst().next()) {
    ...
    public ArrayList lista_historial_sesion(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT vis_id, vis_usuario,vis_duo,   nombre_usuario, apellidop_usuario,apellidom_usuario, TO_CHAR( vis_fecha_ingreso,'DD/MM/YYYY HH24:MI:SS') as vis_fecha_ingreso,  TO_CHAR(  vis_fecha,'DD/MM HH24:MI') as vis_fecha1,  TO_CHAR(  vis_fecha,'DD/MM') as vis_dia,   TO_CHAR(  vis_fecha,'HH24:MI') as vis_hora,    vis_evolucion, vis_estado, vis_usuario_anula, vis_motivo_anula  FROM  schema_uhd.sesion   VIS INNER JOIN schema_uo.usuario USU ON (VIS.vis_usuario= USU.rut_usuario) WHERE vis_duo='" + id_duo + "' order by vis_fecha DESC ;");
        this.cnn.conectar();
    ...
    public Vector<cDuo> listadelDiasector1() {
        ...
        this.cnn.setSentenciaSQL("SELECT c.descripcion_cama, COALESCE( D.rut_paciente, '') as rut_paciente,COALESCE(lower(apellido_paterno),'') as  paciente_apellidop ,\n"
                ...
                + "     FROM schema_uhd.visita AA  \n"
                + "    JOIN schema_uhd.visita_categorizacion BB ON \n"
                ...
                + "     FROM schema_uhd.cama C left JOIN schema_uhd.duo D ON D.id_cama = C.id_cama \n"
                + "      and D.estado_duo in (2,1, 3, 21)\n"
                + "      left JOIN schema_uhd.sala   \n"
                + "       ON (schema_uhd.sala.id_sala=C.id_sala) \n"
                + "       left JOIN agenda.paciente  \n"
                + "       ON (agenda.paciente.rut=D.rut_paciente) \n"
                + "       where C.id_sala in (11) and C.estado_cama=1 order by schema_uhd.sala.posicion ");
        this.cnn.conectar();
        try {
    ...
    public Vector<cDuo> listadelDiasector2() {
        ...
        this.cnn.setSentenciaSQL("  SELECT c.descripcion_cama, COALESCE( D.rut_paciente, '') as rut_paciente,COALESCE(lower(apellido_paterno),'') as  paciente_apellidop ,\n"
                ...
                + "                left JOIN agenda.paciente \n"
                + "                     ON (agenda.paciente.rut=D.rut_paciente)\n"
                + "                    where C.id_sala in (12) and C.estado_cama=1 order by schema_uhd.sala.posicion");
        this.cnn.conectar();
        try {
            while (cnn.getRst().next()) {
                cDuo duo = new cDuo();
    ...
    public Vector<cCategorizacion> searchCategory() {
        ...
        this.cnn.setSentenciaSQL("select C.id_categorizacion,C.descripcion_categorizacion "
                + "from schema_uhd.categorizacion C where C.estado_categorizacion=1 and C.id_categorizacion!=0 order by C.descripcion_categorizacion");
        this.cnn.conectar();
    ...
    public Vector<cVisita> searchInfoCategory(Date initDate, Date end) {
        ...
        this.cnn.setSentenciaSQL("select TO_CHAR(V.fecha_visita,'DD/MM/YYYY') as fecha_visita , TO_CHAR(V.hora_visita,'HH24:MI') as hora_visita, V.rut_usuario , U.nombre_usuario ||' ' ||U.apellidop_usuario AS usuario_registra,\n"
                ...
                + "                from schema_uhd.visita V,schema_uhd.visita_categorizacion VC, schema_uhd.usuario U,\n"
                + "                schema_uhd.duo d , agenda.paciente p\n"
    ...
    public int countCategory(Date time, String descriptionCategory) {
        ...
        Integer count = 0;
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("select  count(*)as quantity from schema_uhd.visita V,schema_uhd.visita_categorizacion VC \n"
    ...
    public ArrayList lista_camas_actuales() {
        ...
        this.cnn.setSentenciaSQL("SELECT duo.id_duo, \n"
                ...
                + "                  schema_uhd.derivador de, \n"
                + "                  agenda.prevision pp, \n"
                + "                 agenda.tramo cf, \n"
                + "                 schema_uhd.duo duo \n"
                + "                  LEFT JOIN schema_uhd.epicrisis e ON e.id_duo = duo.id_duo \n"
    ...
    public cReceta searchLastRecipe(int duo) {
        ...
        this.cnn.setSentenciaSQL("SELECT \n"
                ...
                + "FROM \n"
                + "  schema_uhd.indicaciones ind\n"
                + "  JOIN schema_uhd.usuario usu ON ind.usuario = usu.rut_usuario where idduo = " + duo + "\n"
    ...
    public int lista_duos_hoy(String fecha_hoy, int modo) {
        ...
        this.cnn.setEsSelect(true);
        if (modo == 1) {
            this.cnn.setSentenciaSQL("select count(*) as suma  from schema_uhd.duo D where D.fecha_duo=CURRENT_DATE and estado_duo NOT IN (99)");
        } else {
            this.cnn.setSentenciaSQL("select  count(*) as suma   from schema_uhd.epicrisis E where E.fecha_epicrisis=CURRENT_DATE");
        }
    ...
    public ArrayList lista_sesion_odontologos(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  ses_id, ses_estado, ses_usuario, \n TO_CHAR(ses_fecha_ingreso,'DD/MM/YYYY HH24:MI:SS')as ses_fecha_ingreso, TO_CHAR(ses_fecha_hora,'DD/MM/YYYY HH24:MI:SS')as ses_fecha_hora, \n TO_CHAR(ses_fecha_hora,'DD/MM/YYYY')as ses_fecha,\n TO_CHAR(ses_fecha_hora,'HH24:MI:SS')as ses_hora,\n ses_detalle, ses_duo,\n USU.nombre_usuario,USU.apellidop_usuario,USU.apellidom_usuario\n FROM  schema_uhd.odontologo_sesion\n SES INNER JOIN schema_uhd.usuario USU ON(SES.ses_usuario=USU.rut_usuario)\n WHERE  ses_duo='" + id_duo + "' and ses_estado='1'  order by SES.ses_fecha_hora desc  ;");
        this.cnn.conectar();
    ...
    public String getCatRiesgo(int valor_riesgo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("select * from schema_uhd.cat_riesgo CR where " + valor_riesgo + " between CR.desde_cat_riesgo and CR.hasta_cat_riesgo");
        this.cnn.conectar();
    ...
    public String getCatDependencia(int valor_dependencia) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("select * from schema_uhd.cat_dependencia CD where " + valor_dependencia + " between CD.desde_cat_dependencia and CD.hasta_cat_dependencia");
        this.cnn.conectar();
    ...
    public cVisita obtiene_visita_medica(int id_visita_medica) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT vis_id, vis_usuario,   vis_duo,  TO_CHAR( vis_fecha_ingreso,'DD/MM/YYYY HH24:MI:SS') as vis_fecha_ingreso,  TO_CHAR( vis_fecha,'DD/MM HH24:MI') as vis_fecha1,  TO_CHAR( vis_fecha,'DD/MM') as vis_dia,  TO_CHAR(vis_fecha,'HH24:MI') as vis_hora,   vis_evolucion, vis_estado, vis_usuario_anula, vis_motivo_anula  FROM  schema_uhd.visita_medica WHERE vis_id='" + id_visita_medica + "' ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_historial_paciente(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("select  fecha,    hora,    proviene,    profesional,   descripcion , fechadate from schema_uhd.sesiones where duo = " + id_duo + " ORDER BY fechadate desc");
        this.cnn.conectar();
    ...
    public ArrayList lista_historial_visita_medica(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT vis_id, vis_usuario,vis_duo,   nombre_usuario, apellidop_usuario,apellidom_usuario, TO_CHAR( vis_fecha_ingreso,'DD/MM/YYYY HH24:MI:SS') as vis_fecha_ingreso,  TO_CHAR(  vis_fecha,'DD/MM HH24:MI') as vis_fecha1,  TO_CHAR(  vis_fecha,'DD/MM') as vis_dia,   TO_CHAR(  vis_fecha,'HH24:MI') as vis_hora,    vis_evolucion, vis_estado, vis_usuario_anula, vis_motivo_anula  FROM  schema_uhd.visita_medica   VIS INNER JOIN schema_uhd.usuario USU ON (VIS.vis_usuario= USU.rut_usuario) WHERE vis_duo='" + id_duo + "' order by vis_fecha DESC ;");
        this.cnn.conectar();
    ...
    public cDuo obtiene_duo_liviano(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT * FROM schema_uhd.duo  where id_duo='" + id_duo + "' ; ");
        this.cnn.conectar();
    ...
    public int IngresoOld(int id_duo) {
        this.configurarConexion("");
        int count = 0;
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT count(*)\n"
                + "  FROM schema_uhd.ing_enfermeria WHERE id_duo_ing_enfermeria= 83;");
        this.cnn.conectar();

        try {
            if (this.cnn.getRst().next()) {
                count = this.cnn.getRst().getInt("count");
    ...
    public cDuo obtiene_duo(int id_duo) {
        ...
        this.cnn.setSentenciaSQL("SELECT  \n"
                ...
                + " nombre_completo  \n"
                + " FROM  schema_uhd.usuario where rut_usuario=AA.rut_usuario) as nombre_admisor,  \n"
                ...
                + "  rut_usuario_ing_med, \n"
                + "(SELECT to_char(LL.fecha_hora_ing_enfermeria,'DD/MM/YYYY HH24:MI:SS') as fecha_hora_ing_enfermeria FROM schema_uhd.ing_enfermeria LL   \n"
                + " where LL.id_duo_ing_enfermeria=AA.id_duo \n"
                + " union\n"
                ...
                + " EXTRACT(DAY FROM (CURRENT_DATE+CURRENT_TIME)-(fecha_duo+hora_duo)) as dias_cama2, AA.indicaciones_medicas  \n"
                + "  FROM schema_uhd.duo AA  \n"
                ...
                + "(tramo.id=BB.tramo)  \n"
                + " JOIN schema_uhd.cama ON (AA.id_cama=cama.id_cama)"
                + " join agenda.comuna c on  (bb.id_comuna = c.id_comuna)   \n"
                + "\n"
                + " JOIN schema_uhd.derivador ON (AA.id_derivador=derivador.id_derivador)  \n"
                + " JOIN schema_uhd.categorizacion ON (AA.id_categorizacion=categorizacion.id_categorizacion) \n"
                + " where id_duo='" + id_duo + "' ");
        this.cnn.conectar();
        try {
            if (cnn.getRst().next()) {
                ...
                duo.setDias_cama(cnn.getRst().getInt("dias_cama2"));
                duo.setIndicacionesMedicas(cnn.getRst().getString("indicaciones_medicas"));
    ...
    public ArrayList obtiene_duo_enfermedad(int duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  id_duo_enfermedad_cro,id_duo,   AA.id_enfermedad_cro, BB.descripcion_enfermedad_cro    FROM  schema_uhd.duo_enfermedad_cro AA    JOIN schema_uhd.enfermedad_cro BB ON (AA.id_enfermedad_cro=BB.id_enfermedad_cro)    where id_duo='" + duo + "'");
        this.cnn.conectar();
    ...
    public ArrayList lista_diagnostico(int id_duo, String tipo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT   id_diagnostico_duo, descripcion_diagnostico_duo,  tipo_diagnostico_duo, id_duo  FROM  schema_uhd.diagnostico_duo where id_duo='" + id_duo + "' and  tipo_diagnostico_duo IN (" + tipo + ") ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_diagnostico_trazador(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  duop_id,duop_duo, duop_prestacion,pre_nombre,  duop_estado,to_char(duop_ingreso,'DD/MM/YYYY HH24:MI:SS')as duop_ingreso  FROM  schema_uhd.prestacion_duo PED JOIN schema_uhd.prestacion PRE  ON (PED.duop_prestacion=PRE.pre_id) WHERE  duop_duo=" + id_duo + " and duop_estado=1  ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_enfermedad_cronica(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  id_duo_enfermedad_cro, id_duo,DEC.id_enfermedad_cro,descripcion_enfermedad_cro  FROM  schema_uhd.duo_enfermedad_cro DEC  JOIN schema_uhd.enfermedad_cro ENF ON (DEC.id_enfermedad_cro=ENF.id_enfermedad_cro)  WHERE DEC.id_duo='" + id_duo + "'");
        this.cnn.conectar();
    ...
    public GradoCRD getGradoCRD(int id_ambito_crd, int valor) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("select descripcion_grado_crd from schema_uhd.grado_crd  where id_ambito_crd=" + id_ambito_crd + " and puntaje_grado_crd=" + valor);
        this.cnn.conectar();
        try {
            while (cnn.getRst().next()) {
                gra = new GradoCRD();
    ...
    public AmbitoCRD getAmbitoCRD(int id_ambito_crd) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("select * from schema_uhd.ambito_crd A where A.id_ambito_crd=" + id_ambito_crd);
        this.cnn.conectar();
        try {
            while (cnn.getRst().next()) {
                amb = new AmbitoCRD();
    ...
    public ArrayList lista_grilla_camas() {
        ...
        this.cnn.setSentenciaSQL("SELECT to_char(D.fecha_duo,'DD/MM/YYYY') as fecha_duo ,D.hora_duo,\n"
                + "                            C.id_cama,C.id_sala,schema_uhd.sala.descripcion_sala ,C.descripcion_cama,\n"
    ...
    public ArrayList lista_documentos_paciente(String rut_paciente) {
        ...
        /*  FIN 23082013
         ...
         + " FROM schema_uhd.duo D LEFT JOIN schema_uhd.epicrisis E "
        ...
        this.cnn.setSentenciaSQL("SELECT D.id_duo,D.estado_duo,to_char(D.fecha_duo,'DD/MM/YYYY')as fecha_duo ,E.id_epicrisis, \n"
                ...
                + "                 LEFT JOIN schema_uhd.epicrisis E ON D.id_duo=E.id_duo \n"
                + "                 \n"
    ...
    public cEpicrisis obtiene_epicrisis(String id_epicrisis) {
        ...
        this.cnn.setSentenciaSQL("SELECT  id_epicrisis,resumen_epicrisis,examen_epicrisis, \n"
                ...
                + "  apellido_paterno,apellido_moderno  FROM schema_uhd.epicrisis AA   \n"
                + "  JOIN schema_uhd.usuario BB ON   (AA.rut_usuario=BB.rut_usuario)  \n"
                + "  JOIN schema_uhd.duo ON  (AA.id_duo=schema_uhd.duo.id_duo)  \n"
                + "  JOIN agenda.paciente ON \n"
                + "  (schema_uhd.duo.rut_paciente=agenda.paciente.rut)  where id_epicrisis='" + id_epicrisis + "';");
        this.cnn.conectar();
    ...
    public ArrayList lista_cama_desocupada(String salas) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT C.id_cama,C.descripcion_cama,D.id_duo,S.descripcion_sala   FROM schema_uhd.sala S,schema_uhd.cama C left JOIN schema_uhd.duo D  ON D.id_cama = C.id_cama and D.estado_duo NOT IN (4,99)  where D.id_duo isnull and S.id_sala=C.id_sala and C.estado_cama=1   and S.id_area_clinica IN (1) and S.id_sala IN (" + salas + ")  order by C.id_cama");
        this.cnn.conectar();
    ...
    public ArrayList getAdmissionHospitalization(String init, String end) {
        ...
        this.cnn.setSentenciaSQL("select d.rut_paciente,\n"
                ...
                + "                (select dr.descripcion_derivador from schema_uhd.derivador dr where dr.id_derivador= p.procedencia) as origen,\n"
                + "                d.rut_usuario,\n"
                ...
                + "                (SELECT LL.rut_usuario_ing_enfermeria FROM schema_uhd.ing_enfermeria LL    where LL.id_duo_ing_enfermeria=d.id_duo limit 1) as rut_ing_enf,\n"
                + "                (SELECT to_char(LL.fecha_hora_ing_enfermeria,'DD/MM/YYYY') as fecha_hora_ing_enfermeria FROM schema_uhd.ing_enfermeria LL    where LL.id_duo_ing_enfermeria=d.id_duo limit 1) as fecha_ing_enf,\n"
                + "                (SELECT to_char(LL.fecha_hora_ing_enfermeria,'HH24:MI') as fecha_hora_ing_enfermeria FROM schema_uhd.ing_enfermeria LL    where LL.id_duo_ing_enfermeria=d.id_duo limit 1) as hora_ing_enf,  \n"
                + "                ( SELECT BB.cat_visita_categorizacion     FROM schema_uhd.visita AA      JOIN schema_uhd.visita_categorizacion BB ON     (AA.id_visita_categorizacion=BB.id_visita_categorizacion)      where id_duo=d.id_duo order by AA.fecha_hora_visita ASC limit 1 ) as primera_cat,\n"
                + "                ( SELECT to_char(aa.fecha_visita,'DD/MM/YYYY')     FROM schema_uhd.visita AA      JOIN schema_uhd.visita_categorizacion BB ON     (AA.id_visita_categorizacion=BB.id_visita_categorizacion)      where id_duo=d.id_duo order by AA.fecha_hora_visita ASC limit 1 ) as fecha_cat,\n"
                + "                ( SELECT to_char(aa.hora_visita,'HH24:MI')    FROM schema_uhd.visita AA      JOIN schema_uhd.visita_categorizacion BB ON     (AA.id_visita_categorizacion=BB.id_visita_categorizacion)      where id_duo=d.id_duo order by AA.fecha_hora_visita ASC limit 1 ) as hora_cat\n"
                + "                 from schema_uhd.duo d inner join agenda.paciente p on p.rut = d.rut_paciente where  d.fecha_duo BETWEEN '" + init + "' and '" + end + "' ");
        this.cnn.conectar();
    ...
    public ArrayList lista_derivador() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT    id_derivador, descripcion_derivador, estado_crd_deriador  FROM  schema_uhd.derivador where estado_derivador='1' ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_destino() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  id_destino,  descripcion_destino, estado_destino  FROM   schema_uhd.destino where estado_destino='1' ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_categorizacion() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT id_categorizacion,descripcion_categorizacion  FROM  schema_uhd.categorizacion where  estado_categorizacion='1' order by id_categorizacion;");
        this.cnn.conectar();
    ...
    public ArrayList lista_documentos() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT id_documento, descripcion_documento  FROM  schema_uhd.documento where estado_documento='1' ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_prestacion_trazadora() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  pre_id,pre_nombre  FROM  schema_uhd.prestacion where  pre_estado=3 order by pre_nombre;");
        this.cnn.conectar();
    ...
    public ArrayList lista_enfermedad_cronica() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  id_enfermedad_cro,descripcion_enfermedad_cro  FROM  schema_uhd.enfermedad_cro AA where  estado_enfermedad_cro='1'   order by descripcion_enfermedad_cro ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_riesgo_dependendencia() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("select * from schema_uhd.ambito_crd ACRD where ACRD.estado_ambito_crd=1 order by ACRD.id_ambito_crd");
        this.cnn.conectar();
    ...
    public cDuo obtiene_dato_segun_duo(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT id_duo,id_cama  FROM   schema_uhd.duo where id_duo='" + id_duo + "' ;");
        this.cnn.conectar();
    ...
    public ArrayList listadelDia() {
        ...
        this.cnn.setSentenciaSQL("SELECT c.descripcion_cama, COALESCE( D.rut_paciente, '') as rut_paciente,COALESCE(initcap(p.apellido_paterno),'') as  paciente_apellidop ,\n"
                ...
                + "                                               where C.id_sala in (11,12) and C.estado_cama=1 order by schema_uhd.sala.posicion\n"
                + "  \n"
                + "   ");
        this.cnn.conectar();
        try {
    ...
    public cReceta bucarindicacion(int idindicaciones) {
        ...
        this.cnn.setSentenciaSQL("SELECT \n"
                ...
                + "FROM \n"
                + "  schema_uhd.indicaciones ind\n"
                + "  JOIN schema_uhd.usuario usu ON ind.usuario = usu.rut_usuario where idindicaciones = " + idindicaciones + "\n"
                + "  order by hora desc limit 1 ");
    ...
    public Vector<String> buscarRecetadeIndicaciones(int indicaciones) {
        ...
        this.cnn.setSentenciaSQL("select ir.cantidad ||' '|| i.ins_descripcion ||' en '|| um.uni_descripcion\n"
                ...
                + "                 from  schema_uhd.indicaciones_receta ir inner join\n"
                ...
                + "               join schema_uhd.via_medicamento vm on vm.id_via_medicamento = ir.id_via\n"
    ...
    public Vector<String> buscarRecetadeIndicacionesDuo(int duo) {
        ...
        this.cnn.setSentenciaSQL("select ir.cantidad ||' '|| i.ins_descripcion ||' en '|| um.uni_descripcion\n"
                ...
                + "               join schema_abastecimiento.insumo  i on ir.id_medicamento = i.ins_id\n"
                + "               join schema_uhd.via_medicamento vm on vm.id_via_medicamento = ir.id_via\n"
                + "               join  schema_uhd.indicaciones ic on ic.idindicaciones= ir.id_indicaciones\n"
    ...
    public Vector<String> buscarSolicitudExamenesdeIndicaciones(int indicaciones) {
        ...
        this.cnn.setSentenciaSQL("SELECT e.nombre_examenes\n"
                + "  FROM schema_uhd.solicitudexamenes_indicaciones sei\n"
    ...
    public Vector<String> buscarSolicitudExamenesdeIndicacionesDuo(int duo) {
        ...
        this.cnn.setSentenciaSQL("SELECT e.nombre_examenes\n"
                ...
                + "                 join  schema_uhd.indicaciones ic on ic.idindicaciones= sei.idindicaciones\n"
                + "               where ic.idduo =" + duo + " ");
    ...
    public cEpicrisis getEpicrisis(int idDuo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("select to_char(fecha_hora_epicrisis, 'dd/mm/yyyy HH24:MI:SS') as fecha , * from schema_uhd.epicrisis e inner join schema_uhd.usuario u on u.rut_usuario= e.rut_usuario  where id_duo=" + idDuo + "");
        this.cnn.conectar();
        try {
    ...
    public cIngreso_Medico Buscaringreso(int diduo) {
        ...
        this.cnn.setSentenciaSQL("SELECT \n"
                ...
                + "  usuario\n"
                + "FROM \n"
                + "  schema_uhd.ingreso_medico WHERE id_duo = " + diduo + " ;");
        this.cnn.conectar();
    ...
    public String tiempo_desde_alta_med(int duo) {
        ...
        this.cnn.setSentenciaSQL("  Select "
                ...
                + " from schema_uhd.epicrisis AA where AA.id_duo='" + duo + "'");
        this.cnn.conectar();
        try {
            if (cnn.getRst().next()) {
    ...
    public ArrayList lista_perfil() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  id_perfil, descripcion_perfil,  estado_perfil, tipo_perfil  FROM  schema_uhd.perfil where estado_perfil='1' ;");
        this.cnn.conectar();
    ...
    public ArrayList obtiene_usuario_sistema(String columna, String valor) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL(" SELECT  rut_usuario,nombre_usuario,  apellidop_usuario,apellidom_usuario  FROM  schema_uhd.usuario where upper(" + columna + ") LIKE '" + valor + "%';");
        this.cnn.conectar();
    ...
    public ArrayList lista_vista_duo(String campo_fecha, String fecha1, String fecha2, String resto_sql) {
        ...
        this.cnn.setSentenciaSQL("SELECT duo.id_duo,e.id_epicrisis,duo.estado_duo, p.rut as paciente_rut, \n"
                ...
                + "                                FROM agenda.paciente p, \n"
                + "                               schema_uhd.destino d, schema_uhd.duo duo, schema_uhd.epicrisis e, \n"
                + "                               schema_uhd.alta_adm a,schema_uhd.derivador de, \n"
                + "                              agenda.prevision pp,\n"
                + "                             schema_uhd.ing_enfermeria ie,schema_uhd.usuario gg ,\n"
                + "                             agenda.tramo t\n"
                + "                               WHERE p.rut = duo.rut_paciente AND \n"
    ...
    public ArrayList lista_hitos(String rut_paciente) {
        ...
        this.cnn.setSentenciaSQL("SELECT \n"
                ...
                + " FROM  schema_uhd.hito_paciente AA \n"
                + "JOIN schema_uhd.hito_tipo BB ON (AA.hit_tipo=BB.hit_id)  \n"
                + "  JOIN agenda.paciente CC ON (AA.hit_paciente_rut=CC.rut) \n"
                + "  JOIN schema_uhd.usuario DD ON (AA.hit_usuario=DD.rut_usuario)  \n"
    ...
    public ArrayList lista_tipo_hito() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL(" SELECT  hit_id,hit_descripcion,hit_estado,  hit_fecha_creacion FROM schema_uhd.hito_tipo where hit_estado='1' ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_usuario_segun_perfil(int perfil) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  rut_usuario,nombre_usuario,  apellidop_usuario, apellidom_usuario FROM  schema_uhd.usuario WHERE estado_usuario='1' AND perfil_usuario='" + perfil + "' ; ");
        this.cnn.conectar();
    ...
    public cIngresoEnfermeria obtiene_ingreso_enfermeria(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT id_ing_enfermeria, fecha_hora_ing_enfermeria, rut_usuario_ing_enfermeria, \n"
                ...
                + "       ecg, educacion, documento,nombre_usuario,apellidop_usuario,apellidom_usuario, frecuencia_respiratoria\n"
                + "  FROM schema_uhd.ing_enfermeria_uhd ENF\n"
                + "  INNER JOIN schema_uhd.usuario USU ON (ENF.rut_usuario_ing_enfermeria=USU.rut_usuario) WHERE  id_duo_ing_enfermeria=" + id_duo + " LIMIT 1");
        this.cnn.conectar();
        ...
        try {
            while (this.cnn.getRst().next()) {
                ...
                enf.setVariable1(this.cnn.getRst().getString("morbilidades"));
                enf.setApellidom_usuario(this.cnn.getRst().getString("apellidom_usuario"));
                enf.setFarmaco_ing_enfermeria(this.cnn.getRst().getString("farmacos"));
                enf.setVariable2(this.cnn.getRst().getString("alergias"));
                enf.setVariable3(this.cnn.getRst().getString("plan"));
                enf.setPA(this.cnn.getRst().getString("pa"));
                enf.setFC(this.cnn.getRst().getString("fc"));
                enf.setT(this.cnn.getRst().getString("t"));
                enf.setSAT(this.cnn.getRst().getString("sat"));
                enf.setFI02(this.cnn.getRst().getString("fio2"));
                enf.setHGT(this.cnn.getRst().getString("hgt"));
                enf.setEvolucion_enfermeria(this.cnn.getRst().getString("evolucion"));
                enf.setVvp(this.cnn.getRst().getString("vvp"));
                enf.setCup(this.cnn.getRst().getString("cup"));
                enf.setSng(this.cnn.getRst().getString("sng"));
                enf.setSny(this.cnn.getRst().getString("sny"));
                enf.setGtt(this.cnn.getRst().getString("gtt"));
                enf.setPicc(this.cnn.getRst().getString("picc"));
                enf.setCvc(this.cnn.getRst().getString("cvc"));
                enf.setTqt(this.cnn.getRst().getString("tqt"));
                enf.setLpp(this.cnn.getRst().getString("lpp"));
                enf.setPrestaciones_realizadas(this.cnn.getRst().getString("prestaciones"));
                enf.setVenoso(this.cnn.getRst().getString("venoso"));
                enf.setArterial(this.cnn.getRst().getString("arterial"));
                enf.setOtro(this.cnn.getRst().getString("otro"));
                enf.setPcr(this.cnn.getRst().getString("pcr"));
                enf.setEcg(this.cnn.getRst().getString("ecg"));
                enf.setEducacion(this.cnn.getRst().getString("educacion"));
                enf.setVariable4(this.cnn.getRst().getString("documento"));
                enf.setFrecuenciaRespiratoria(this.cnn.getRst().getString("frecuencia_respiratoria"));
            }
        } catch (SQLException var4) {
            Logger.getLogger(Negocio.class.getName()).log(Level.SEVERE, (String) null, var4);
        }
    ...
    public ArrayList listada_categorizaciones(String fecha_inicial, String fecha_final) {
        ...
        this.cnn.setSentenciaSQL(" SELECT \n"
                ...
                + "                 FROM  \n"
                + "                 schema_uhd.visita AA JOIN schema_uhd.visita_categorizacion BB ON  \n"
                + "                 (AA.id_visita_categorizacion=BB.id_visita_categorizacion)\n"
                + "                 JOIN schema_uhd.usuario CC ON (CC.rut_usuario=AA.rut_usuario) \n"
                + "                 JOIN schema_uhd.duo DD ON (DD.id_duo=AA.id_duo) \n"
                + "                 JOIN schema_uhd.cama EE ON (AA.id_cama=EE.id_cama) \n"
...
//                duo.setFecha_nac(cnn.getRst().getString("paciente_fecha_nac"));
    ...
    public cDuo obtiene_fecha_enfermeria_medico_ingreso(int numero_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("  Select fecha_hora_ing_med as fecha,  EXTRACT(SECOND FROM CURRENT_TIMESTAMP-fecha_hora_ing_med) as dif_ss,    EXTRACT(MINUTE FROM CURRENT_TIMESTAMP-fecha_hora_ing_med) as dif_mm,     EXTRACT(HOUR FROM CURRENT_TIMESTAMP-fecha_hora_ing_med)as dif_hh,     EXTRACT(DAY FROM CURRENT_TIMESTAMP-fecha_hora_ing_med)as dif_dd,  'medico' as tipo  from schema_uhd.duo where id_duo='" + numero_duo + "'  UNION  SELECT   fecha_hora_ing_enfermeria as fecha,  EXTRACT(SECOND FROM CURRENT_TIMESTAMP-fecha_hora_ing_enfermeria) as dif_ss,    EXTRACT(MINUTE FROM CURRENT_TIMESTAMP-fecha_hora_ing_enfermeria) as dif_mm,     EXTRACT(HOUR FROM CURRENT_TIMESTAMP-fecha_hora_ing_enfermeria)as dif_hh,     EXTRACT(DAY FROM CURRENT_TIMESTAMP-fecha_hora_ing_enfermeria)as dif_dd,  'enfermeria' as tipo  FROM     schema_uhd.ing_enfermeria   where id_duo_ing_enfermeria='" + numero_duo + "' UNION  SELECT   fecha_hora_ing_enfermeria as fecha,  EXTRACT(SECOND FROM CURRENT_TIMESTAMP-fecha_hora_ing_enfermeria) as dif_ss,    EXTRACT(MINUTE FROM CURRENT_TIMESTAMP-fecha_hora_ing_enfermeria) as dif_mm,     EXTRACT(HOUR FROM CURRENT_TIMESTAMP-fecha_hora_ing_enfermeria)as dif_hh,     EXTRACT(DAY FROM CURRENT_TIMESTAMP-fecha_hora_ing_enfermeria)as dif_dd,  'enfermeria' as tipo  FROM     schema_uhd.ing_enfermeria_uhd   where id_duo_ing_enfermeria='" + numero_duo + "'  order by fecha asc ; ");
        this.cnn.conectar();
    ...
    public ArrayList obtiene_duo_liviano_x_fecha() {
        ...
        this.cnn.setSentenciaSQL("SELECT  \n"
                ...
                + "                 BB.apellido_paterno as  paciente_apellidop, \n"
                + "                 BB.apellido_moderno as paciente_apellidom \n"
                + "                FROM  schema_uhd.duo AA JOIN agenda.paciente BB ON \n"
                + "               (AA.rut_paciente=BB.rut) \n"
    ...
    public ArrayList lista_documento_segun_duo(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT \n  id_duo_documento,\n  DOC.id_documento,\n DOC.descripcion_documento\nFROM  schema_uhd.duo_documento DUO\nINNER JOIN schema_uhd.documento DOC ON (DUO.id_documento=DOC.id_documento)\n WHERE  id_duo='" + id_duo + "';");
        this.cnn.conectar();
    ...
    public ArrayList lista_diagnostico_segun_duo() {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL(" SELECT    id_diagnostico_duo, descripcion_diagnostico_duo,   tipo_diagnostico_duo, id_duo   FROM  schema_uhd.diagnostico_duo   where id_duo  IN (SELECT id_duo  FROM  schema_uhd.duo AA WHERE id_derivador=2 and estado_duo NOT IN (99) AND   (fecha_duo+hora_duo) BETWEEN '01-01-2012 00:00:00' AND '12-31-2012 23:59:59'  ) and  tipo_diagnostico_duo IN (1) ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_sesion_fonouriologa(int id_duo) {
        ...
        this.cnn.setSentenciaSQL("SELECT  ses_id, ses_estado, ses_usuario, TO_CHAR(ses_fecha_ingreso,'DD/MM/YYYY HH24:MI:SS')as ses_fecha_ingreso,"
                ...
                + "'HH24:MI:SS')as ses_hora, ses_detalle, ses_duo,"
                + " USU.nombre_usuario,USU.apellidop_usuario,USU.apellidom_usuario"
                + " FROM  schema_uhd.fonouriologa_sesion SES INNER JOIN schema_uhd.usuario USU ON(SES.ses_usuario=USU.rut_usuario) WHERE "
                + " ses_duo='" + id_duo + "' and ses_estado='1' order by SES.ses_fecha_hora desc  ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_sesion_terapeuta(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  ses_id, ses_estado, ses_usuario, \n TO_CHAR(ses_fecha_ingreso,'DD/MM/YYYY HH24:MI:SS')as ses_fecha_ingreso, TO_CHAR(ses_fecha_hora,'DD/MM/YYYY HH24:MI:SS')as ses_fecha_hora, \n TO_CHAR(ses_fecha_hora,'DD/MM/YYYY')as ses_fecha,\n TO_CHAR(ses_fecha_hora,'HH24:MI:SS')as ses_hora,\n ses_detalle, ses_duo,\n USU.nombre_usuario,USU.apellidop_usuario,USU.apellidom_usuario\n FROM  schema_uhd.terapeuta_sesion\n SES INNER JOIN schema_uhd.usuario USU ON(SES.ses_usuario=USU.rut_usuario)\n WHERE  ses_duo='" + id_duo + "' and ses_estado='1'  order by SES.ses_fecha_hora desc ;");
        this.cnn.conectar();
    ...
    public ArrayList lista_sesion_nutricionista(int id_duo) {
        ...
        this.configurarConexion("");
        this.cnn.setEsSelect(true);
        this.cnn.setSentenciaSQL("SELECT  ses_id, ses_estado, ses_usuario, \n TO_CHAR(ses_fecha_ingreso,'DD/MM/YYYY HH24:MI:SS')as ses_fecha_ingreso, TO_CHAR(ses_fecha_hora,'DD/MM/YYYY HH24:MI:SS')as ses_fecha_hora, \n TO_CHAR(ses_fecha_hora,'DD/MM/YYYY')as ses_fecha,\n TO_CHAR(ses_fecha_hora,'HH24:MI:SS')as ses_hora,\n ses_detalle, ses_duo,\n USU.nombre_usuario,USU.apellidop_usuario,USU.apellidom_usuario\n FROM  schema_uhd.nutricionista_sesion\n SES INNER JOIN schema_uhd.usuario USU ON(SES.ses_usuario=USU.rut_usuario)\n WHERE  ses_duo='" + id_duo + "' and ses_estado='1'  order by SES.ses_fecha_hora desc  ;");
        this.cnn.conectar();
