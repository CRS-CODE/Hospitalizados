...
public class ingresa_visita_medica extends HttpServlet {
    public ingresa_visita_medica() {
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session1.getAttribute("usuario_rut") == null) {
            ...
            if (obtiene_modo == 1) {
                ...
                neg.ingresa_visita_medica(vis);
                RequestDispatcher a = request.getRequestDispatcher("index.jsp");
                a = request.getRequestDispatcher("visita_medica.jsp?txt_duo=" + obtiene_duo);
