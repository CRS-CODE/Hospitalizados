...
<script>
    ...
    function lista_sesion(ingreso) {
        ...
        obj.open("POST", "sesion_odontologos_carga.jsp", true);
...
<legend>Ingreso sesión del Odontologo</legend>
...
<form  action='../PDF_sesion_odontologos' id="form_documento_registro" method='POST' target='_blank' >
...
<form name="form_sesion_odontologo" action="#" method="POST" onsubmit="return false"  >
