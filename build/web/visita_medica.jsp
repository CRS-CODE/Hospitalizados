...
<script>
    ...
    function busca_visita_medica(visita) {
        ...
        obj.open("GET", "visita_medica_carga.jsp?visita_medica=" + visita, true);
        obj.send(null);
        return (true);
...
<fieldset><legend>Datos del Paciente</legend>
    ...
    <div id="nav">
        <form name="form_paciente" id="form_paciente" action="visita_medica.jsp" method="POST"  >
...
<fieldset>
    ...
    <div id="nav">
        <table>
            <tr>
                <td>
                    <form name="form_formulario" id="form_formulario" action="PDF_visita_medica" method="POST"  target="a_blank" >
            ...
            <tr>
                ...
                <%
                    ArrayList lista = neg.lista_historial_visita_medica(obtiene_duo);
    ...
    <div id="section">
        ...
        <form name="form_evolucion" method="POST" action="ingresa_visita_medica" onsubmit=" return valida_visita_medica();
              "  >
            ...
            <table border="0" >
                ...
                <tr>
                    <td colspan="1" align="right"  >
                        <input class="btn btn-primary"  type="submit" value="Grabar evolución médica" name="btn_grabar" />
                    </td>
                </tr>
            </table>
        </form>
