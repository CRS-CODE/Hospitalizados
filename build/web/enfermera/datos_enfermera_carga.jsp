...
<%
    ...
    ArrayList lista_sesion_fono = neg.lista_sesion_enfermera(id_duo);
...
<table>
    <tr>
        ...
        <td <%=titulo%> >Datos de la Enfermera</td>
    </tr>
    <tr>
...
<table>
    <tr valign="top" >
        <td>
            <fieldset>
                <legend>Sesión Enfermera</legend>
                <table>
                    <tr>
                        <%    //
                            Iterator it_lista_sesion_kine = lista_sesion_fono.iterator();
                            int contador = 0;
                            if (lista_sesion_fono.size() == 0) {
                                ...
                                if (it_lista_sesion_kine.hasNext()) {
                                    ...
                                    out.write("<tr><td>");
                                    out.write("<form  action='../PDF_sesion_enfermera' method='POST' target='_blank' > "
...
<fieldset>
    ...
    <center>
        <TABLE>
            <TR>
                <TD>
                    <form name="form_kin"  action="sesion_enfermera.jsp" method="POST"  >
                        <input type="hidden" name="txt_duo" value="<%=id_duo%>" > 
                        <input class="btn btn-primary" type="submit" value="Registrar Sesión Enfermera" name="btn_ses" />
                    </form> 
                </TD>
