<%-- 
    ...
    Created on : 17-may-2012, 11:39:52
    Author     : EseGamboa
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="history.forward();displayMessage('../ingreso/visita_medico_carga.jsp?duo=<% out.write("" + guarda_duo);%>')">
    </body>
</html>
