<%-- 
    Document   : retroalimentacion
    Created on : 03-feb-2014, 15:44:07
    Author     : Silvio
--%>
...
<script>
    function Enviar() {
        ...
        obj.open("GET", "retroalimentacion_carga.jsp?user="+valor , true);
        obj.send(null);
        return (true);
    }
</script>
...
<form name="index" method="GET" onsubmit="Enviar();return false;"    >
    <table border="0">
        <tbody>
        <thead> <tr><th colspan="3" >DATO RETROALIMENTACION AGENDA MÉDICA</th></tr></thead>
        <tr>
            <td><b>Pacientes admisionados&nbsp;&nbsp;&nbsp;</b></td>
            <td>
                <input type="HIDDEN" name="id_txt_user" id="id_txt_user" value="13.675.420-3" >
                <select>
                    <option>Seleccione paciente...</option>
                    <option>HECTOR PEREZ CLAVERIE</option>
                    <option>RODRIGO TAN BECERRA</option>
