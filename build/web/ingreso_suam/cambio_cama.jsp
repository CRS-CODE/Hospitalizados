<%-- 
    Document   : cambio_cama
    Created on : 28-may-2012, 16:36:04
    Author     : EseGamboa
--%>
...
<%
            ...
            String guarda_modo = request.getParameter("txt_modo").toString().toUpperCase();
%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="history.forward();displayMessage('../ingreso_suam/cambio_cama_carga.jsp?das=<% out.write("" + guarda_das);%>&modo=<% out.write("" + guarda_modo);%>')">
    </body>
</html>
