...
<table>
    <tr>
        <td rowspan="2" ><img src="../Imagenes/kinesiologia.png" width="48" height="48" alt="Psicologia"/></td>
        ...
        <td>
            <fieldset>
                ...
                <table>
                    <tr>
                        <%    //
                            Iterator it_lista_sesion_psicolo = lista_sesion_psicolo.iterator();
                            int contador = 0;
                            if (lista_sesion_psicolo.size() == 0) {
                                ...
                                out.write("<tr><td>");
                                out.write("<form  action='../PDF_sesion_psicolo' method='POST' target='_blank' > "
...
<fieldset>
    ...
    <center>
        <TABLE>
            <TR>
                <TD>
                    <form name="form_kin"  action="sesion_psicologo.jsp" method="POST"  >
                        <input type="hidden" name="txt_duo" value="<%=id_duo%>" > 
                        <input class="btn btn-primary" type="submit" value="Registrar Sesión de Psicologia" name="btn_ses" />
                    </form> 
                </TD>
