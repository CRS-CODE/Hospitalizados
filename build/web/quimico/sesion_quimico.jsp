...
<script>
    ...
    function lista_sesion(ingreso) {
        ...
        obj.open("POST", "sesion_quimico_carga.jsp", true);
...
<legend>Ingreso sesión de Químico Farmacéutico</legend>
...
<form  action='../PDF_sesion_quimico' id="form_documento_registro" method='POST' target='_blank' >
...
<form name="form_sesion_quimico" action="#" method="POST" onsubmit="return false"  >
    ...
    <table  style=" width: 95%" border="0" >
        ...
        <tr VALIGN="TOP">
            ...
            <td rowspan="2">
                <center> <input class="btn btn-primary" type="submit" value="Guardar" name="btn4_grabar" 
