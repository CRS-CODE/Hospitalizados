<%-- 
    Document   : alta_medica
    Created on : 17-may-2012, 12:23:11
    Author     : EseGamboa
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="history.forward();displayMessage('../egreso/alta_medica_carga.jsp?duo=<% out.write("" + guarda_duo);%>')">
    </body>
</html>
