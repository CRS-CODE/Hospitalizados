...
<script>
    ...
    function lista_sesion(ingreso) {
        ...
        obj.open("POST", "sesion_fonoaudiologa_carga.jsp", true);
...
<legend>Ingreso sesión Fonouriologo</legend>
...
<form  action='../PDF_sesion_fono' id="form_documento_registro" method='POST' target='_blank' >
...
<form name="form_sesion_fonoaudiologa" action="#" method="POST" onsubmit="return false"  >
