...
<%
    ...
    ArrayList lista_sesion_tera = neg.lista_sesion_terapeuta(id_duo);
...
<table>
    <tr>
        <td rowspan="2" ><img src="../Imagenes/kinesiologia.png" width="48" height="48" alt="Terapeuta"/></td>
        <td <%=titulo%> Datos del Terapeuta Ocupacional</td>
    </tr>
    <tr>
...
<table>
    <tr valign="top" >
        <td>
            <fieldset>
                <legend>Sesión Terapeuta</legend>
                <table>
                    <tr>
                        <%    //
                            ...
                            } else if (it_lista_sesion_terapeuta.hasNext()) {
                                cSesionKine ses = (cSesionKine) it_lista_sesion_terapeuta.next();
                                contador++;

                                out.write("<tr><td>");
                                out.write("<form  action='../PDF_sesion_terapeuta' method='POST' target='_blank' > "
...
<fieldset>
    ...
    <center>
        <TABLE>
            <TR>
                <TD>
                    <form name="form_kin"  action="sesion_terapeuta.jsp" method="POST"  >
                        <input type="hidden" name="txt_duo" value="<%=id_duo%>" > 
                        <input class="btn btn-primary" type="submit" value="Registrar Sesión Terapeuta" name="btn_ses" />
                    </form> 
                </TD>
