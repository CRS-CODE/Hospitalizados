...
<body onload="document.getElementById('id_txt_user').focus()" >
    ...
    <form name="index" method="GET" onsubmit="Enviar();  return false;"    >
        <legend class="text-center header">Ingrese Paciente</legend>
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <input name="user" class="form-control" placeholder="Rut Paciente" id="id_txt_user"  type="text" size="20" maxlength="12" autocomplete="off" onkeyup="formateaRut(this.value)" value=""   >
                <br>
            </div>
